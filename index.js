...
(function($PS) {
  ...
  var mainContent = CSS_Stylesheet.select(CSS_Selector["with"](CSS_Selector.star)(CSS_Selector.byClass("main-content")))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(560.0)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(570.0)))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.marginTop(CSS_Common.auto(CSS_Size.autoSize)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.paddingTop(CSS_Size.px(50.0)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Color.black))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Data_Maybe.fromMaybe(Color_Scheme_X11.red)(Color.fromHexString("#e9e9e99f"))))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Border.border(CSS_Border.solid)(CSS_Size.px(1.0))(Data_Maybe.fromMaybe(Color_Scheme_X11.red)(Color.fromHexString("#8f8f8f"))))(function () {
                              return CSS_Border.borderRadius(CSS_Size.px(10.0))(CSS_Size.px(0.0))(CSS_Size.px(0.0))(CSS_Size.px(0.0));
                          });
                      });
                  });
              });
  ...
  var clickOperaBtnAct = CSS_Stylesheet.select(classname("click-area .operator .btn:acive"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(hexColor("#ffffff")))(function () {
...
(function($PS) {
      ...
      return Halogen_HTML_Elements.body([ Halogen_HTML_Properties.id_()("index") ])([ Halogen_HTML_Elements.head([  ])([ Halogen_HTML_Elements.meta([ Halogen_HTML_Properties.charset("UTF-8"), Halogen_HTML_Properties.name("viewpoint") ]), Halogen_HTML_Elements.title([  ])([ Halogen_HTML_Core.text("Web\u96fb\u5353") ]), Halogen_HTML_Elements.link([ Halogen_HTML_Properties.href("https://fonts.googleapis.com/css?family=Sawarabi+Mincho|Ultra&display=swap") ]) ]), (function () {
          ...
          return Halogen_HTML_Elements.body([ Halogen_HTML_Properties.id("index") ])([ Halogen_HTML_Elements.header_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("WEB\u96fb\u5353") ]) ]), Halogen_HTML_Elements.main_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("main-content") ])([ (function () {
              var divBtn = function (xs) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("btn") ])([ Halogen_HTML_Core.text(xs) ]);
              };
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("content-area") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("display-area") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("num_display") ])([ Halogen_HTML_Core.text("0") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("howcal_display") ])([  ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("click-area") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("operator") ])([ divBtn("+"), divBtn("-"), divBtn("\xd7"), divBtn("\xf7"), divBtn("AC") ]), Halogen_HTML_Elements.div([ classname("operator") ])([ Halogen_HTML_Elements.div([ classname("row1") ])([ divBtn("7"), divBtn("8"), divBtn("9") ]), Halogen_HTML_Elements.div([ classname("row2") ])([ divBtn("4"), divBtn("5"), divBtn("6") ]), Halogen_HTML_Elements.div([ classname("row3") ])([ divBtn("1"), divBtn("2"), divBtn("3") ]), Halogen_HTML_Elements.div([ classname("row4") ])([ divBtn("0"), divBtn("."), divBtn("C") ]), Halogen_HTML_Elements.div([ classname("row5") ])([ divBtn("=") ]) ]) ]) ]);
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.get(Affjax_ResponseFormat.string)("https://api.github.com/users/" + username)))(function (response) {
                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                                  ...
                                  $18.loading = false;
                                  $18.result = Data_Functor.map(Data_Maybe.functorMaybe)(function (v2) {
                                      return v2.body;
          ...
          throw new Error("Failed pattern match at Main (line 200, column 16 - line 208, column 71): " + [ v.constructor.name ]);
      };
  };
