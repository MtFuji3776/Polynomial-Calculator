...
(function($PS) {
  ...
  var render = function (state) {
      var value = Data_Maybe.maybe("No number generated yet")(Control_Category.identity(Control_Category.categoryFn))(state);
      var divBtn = function (y) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("btn"), Halogen_HTML_Events.onClick(function (v) {
              return new Regenerate(value + y);
          }) ])([ Halogen_HTML_Core.text(y) ]);
      };
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Random number") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Current value: " + value) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return Regenerate.create(value + "Keito\u306e\u91d1\u7389\u3076\u3063\u6f70\u3057\u3066\u3048");
      }) ])([ Halogen_HTML_Core.text("Generate new number") ]), Halogen_HTML_Elements.li_([  ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("main-context") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("content-area") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("display-area") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id("numdisplay") ])([ Halogen_HTML_Core.text(value) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id("howcal_display") ])([  ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("click-area") ])([ divBtn("+"), divBtn("-"), divBtn("\xd7"), divBtn("\xf7"), divBtn("AC") ]) ]) ]) ]);
  };
  ...
  var main = (function () {
      var y = Data_Show.show(Data_Show.showInt)(test(2000));
      return function __do() {
          Effect_Console.log("\ud83c\udf5d \xd7 " + y)();
