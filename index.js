...
(function($PS) {
  ...
  var test2 = function (dictMonad) {
      return Text_Parsing_Parser_Combinators.sepBy(dictMonad)(Data_List.many(Text_Parsing_Parser.alternativeParserT(dictMonad))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_Token.digit(dictMonad)))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(dictMonad)("+"));
  };
  var readChar = function (c) {
      var c$prime = Data_Char.toCharCode(c);
      return c$prime - 48 | 0;
  };
  var readNum_ = function ($copy_v) {
      return function ($copy_ys) {
          var $tco_var_v = $copy_v;
          var $tco_done = false;
          var $tco_result;
          function $tco_loop(v, ys) {
              ...
              if (v instanceof Data_List_Types.Cons) {
                  ...
                  $tco_var_v = v.value1;
                  $copy_ys = new Data_List_Types.Cons(x$prime, Data_Functor.map(Data_List_Types.functorList)(function (y) {
                      return 10 * y | 0;
                  })(ys));
                  return;
              };
              throw new Error("Failed pattern match at Parser (line 57, column 1 - line 57, column 41): " + [ v.constructor.name, ys.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var readNum = function (xs) {
      return readNum_(xs)(Data_List_Types.Nil.value);
  };
  var summation = function (dictFunctor) {
      return function (dictFoldable) {
          return function (cs) {
              var ns = Data_Functor.map(dictFunctor)(readNum)(cs);
              return Data_Foldable.foldr(dictFoldable)(Data_Semiring.add(Data_Semiring.semiringInt))(0)(ns);
          };
      };
  };
  var expr2 = function (xs) {
      return Data_Either.fromRight(Data_List.singleton(Data_List.singleton("0")))(Text_Parsing_Parser.runParser(xs)(test2(Data_Identity.monadIdentity)));
  };
  exports["expr2"] = expr2;
...
(function($PS) {
  ...
  var headFoot = CSS_Stylesheet.select(CSS_Selector.element("header,footer"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(padding_(CSS_Size.px(50.0)))(function () {
...
(function($PS) {
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          if (v instanceof AN) {
              var setFormula = function (x1) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var fm$prime = (function () {
                          var $17 = st.formula === "0";
                          if ($17) {
                              return Data_Show.show(Data_Show.showInt)(x1);
                          };
                          return st.formula + Data_Show.show(Data_Show.showInt)(x1);
                      })();
                      var $18 = {};
                      for (var $19 in st) {
              ...
              if (v.value0 instanceof Four) {
                  return setFormula(4);
              };
              if (v.value0 instanceof Five) {
                  return setFormula(5);
              };
              if (v.value0 instanceof Six) {
                  return setFormula(6);
              };
              if (v.value0 instanceof Seven) {
                  return setFormula(7);
              };
              if (v.value0 instanceof Eight) {
                  return setFormula(8);
              };
              if (v.value0 instanceof Nine) {
                  return setFormula(9);
              };
              throw new Error("Failed pattern match at Main (line 191, column 8 - line 205, column 32): " + [ v.value0.constructor.name ]);
          };
          if (v instanceof AO) {
              ...
              var processOperator = function (st) {
                  return function (op) {
                      var fm$prime = (function () {
                          if (st.isAbleToEvaluate) {
                              return st.formula + Data_Show.show(showActOperator)(op);
                          };
                          return init(st.formula) + Data_Show.show(showActOperator)(op);
                      })();
                      var $28 = {};
                      for (var $29 in st) {
                      ...
                      $28.formula = fm$prime;
                      $28.isAbleToEvaluate = false;
                      $28.isPeriod = false;
                      return $28;
                  };
              };
              if (v.value0 instanceof Plus) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var fm$prime = (function () {
                          if (st.isAbleToEvaluate) {
                              return st.formula + "+";
                          };
                          return init(st.formula) + "+";
                      })();
                      var $33 = {};
                      for (var $34 in st) {
                      ...
                      $33.formula = fm$prime;
                      $33.isAbleToEvaluate = false;
                      $33.isPeriod = false;
                      return $33;
                  });
              };
              if (v.value0 instanceof Minus) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      return processOperator(st)(Minus.value);
                  });
              };
              if (v.value0 instanceof Times) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      return processOperator(st)(Times.value);
                  });
              };
              if (v.value0 instanceof Divide) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      return processOperator(st)(Divide.value);
                  });
              };
              throw new Error("Failed pattern match at Main (line 213, column 8 - line 223, column 63): " + [ v.value0.constructor.name ]);
          };
          if (v instanceof AS) {
              ...
              if (v.value0 instanceof Period) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var xs$prime = (function () {
                          var $38 = st.isAbleToEvaluate && !st.isPeriod;
                          if ($38) {
                              return st.formula + ".";
                          };
                          return st.formula;
                      })();
                      var $39 = !st.isAbleToEvaluate;
                      if ($39) {
                          var $40 = {};
                          for (var $41 in st) {
              ...
              if (v.value0 instanceof Equal) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      if (st.isAbleToEvaluate) {
                          var fm$prime = Parser.expr2(st.formula);
                          var $47 = {};
                          for (var $48 in st) {
                          ...
                          $47.formula = Data_Show.show(Data_Show.showInt)(Parser.summation(Data_List_Types.functorList)(Data_List_Types.foldableList)(fm$prime));
                          return $47;
                      };
                      return st;
                  });
          ...
          throw new Error("Failed pattern match at Main (line 184, column 17 - line 236, column 39): " + [ v.constructor.name ]);
      };
  };
