...
(function($PS) {
  ...
  var a = CSS_Stylesheet.select(CSS_Selector.element("a"))(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Font.color(Color.white))(function () {
  ...
  var readInt_ = function ($copy_v) {
      return function ($copy_ys) {
          ...
          function $tco_loop(v, ys) {
              ...
              throw new Error("Failed pattern match at Parser (line 179, column 1 - line 179, column 41): " + [ v.constructor.name, ys.constructor.name ]);
          };
          while (!$tco_done) {
