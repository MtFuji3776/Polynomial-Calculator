...
(function($PS) {
  ...
  var render = function (st) {
      return Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(function (ev) {
          ...
          throw new Error("Failed pattern match at Main (line 84, column 9 - line 92, column 14): " + [ st.result.constructor.name ]);
      })()) ]);
  };
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 96, column 16 - line 104, column 71): " + [ v.constructor.name ]);
      };
  };
